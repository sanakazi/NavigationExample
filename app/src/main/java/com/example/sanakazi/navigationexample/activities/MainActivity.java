package com.example.sanakazi.navigationexample.activities;
...
public class MainActivity extends ActionBarActivity {
    ...
    int ICONS[] = {R.drawable.ic_menu_gallery,R.drawable.ic_menu_camera,R.drawable.ic_menu_send,R.drawable.ic_menu_manage,R.drawable.ic_menu_share};
    ...
    int PROFILE = R.drawable.ic_menu_camera;
